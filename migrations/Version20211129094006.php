 ...
 */
final class Version20211129094006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, brand VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, year SMALLINT NOT NULL, mileage DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, location VARCHAR(255) NOT NULL, date_first DATETIME NOT NULL, engine VARCHAR(255) NOT NULL, picture VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, booked TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_773DE69D7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
