...
class AddProController extends AbstractController
{


    /**
     * @Route("/add/pro", name="add_pro")
     */
    public function index(Request $request, EntityManagerInterface $manager, SluggerInterface $slugger)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('show_annonce_pro', ['id' => $annonce->getId()]);
        }
        return $this->render('add_pro/index.html.twig', [
            'controller_name' => 'AddProController',
    ...
    public function showAnnoncePro($id)
    {
        ...
        return $this->render('add_pro/annonce_pro.html.twig', [
            'controller_name' => 'AddProController',
            'annonces' => $annonces
